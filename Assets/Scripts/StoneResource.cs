...
public class StoneResource : MonoBehaviour
{
    ...
    [Tooltip("Sound to play when the stone is destroyed")]
    ...
    public void TakeDamage(float damage)
    {
        ...
        if (hitSound != null)
        {
            // Play a "hit" sound at the stone's position
    ...
    private void Die()
    {
        ...
        if (breakSound != null)
        {
            // Play a "break" sound at the stone's position
        ...
        if (stoneDropPrefab != null)
        {
            for (int i = 0; i < dropAmount; i++)
            {
                ...
                Instantiate(stoneDropPrefab, transform.position + offset, Quaternion.identity);
            }
        }
